...
import { Plus, Search, Building2, User, Globe, Mail, MapPin, Briefcase, Edit, Trash2, Loader2, AlertCircle, Download, ArrowUpDown, SlidersHorizontal } from 'lucide-react';
...
export function Clients() {
  ...
  const [sortBy, setSortBy] = useState<string>('name'); // 'name', 'newest'
    ...
    <div className="p-8 space-y-8 animate-in fade-in duration-500 relative">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col xl:flex-row gap-4 items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full xl:w-auto">
          ...
          <div className="w-full sm:w-40">
            <CustomSelect value={sortBy} onChange={setSortBy} options={[{ label: 'Ordem A-Z', value: 'name' }, { label: 'Mais Recentes', value: 'newest' }]} placeholder="Ordenar" actionIcon={ArrowUpDown} />
          </div>
