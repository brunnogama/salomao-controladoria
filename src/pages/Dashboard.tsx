        ...
        <div className='grid grid-cols-1 md:grid-cols-5 gap-4'>
          ...
          <div className='bg-white p-5 rounded-xl shadow-sm border border-blue-100'>
            ...
            <div className='bg-blue-50/50 p-2 rounded-lg space-y-1'>
              <FinItem label='Pró-labore' value={metrics.semana.propPL} colorClass='text-blue-700' />
          ...
          <div className='bg-white p-5 rounded-xl shadow-sm border border-blue-100'>
            ...
            <div className='bg-green-50/50 p-2 rounded-lg space-y-1'>
              <FinItem label='Pró-labore' value={metrics.semana.fechPL} colorClass='text-green-700' />
              <FinItem label='Fixos' value={metrics.semana.fechMensal} colorClass='text-green-700' />
            </div>
          </div>
          ...
          <div className='bg-white p-5 rounded-xl shadow-sm border border-red-100 flex flex-col justify-between'>
            ...
            <div className='mt-2 text-[10px] text-red-300 flex items-center'>
              <XCircle className="w-3 h-3 mr-1" /> Casos declinados
            </div>
          </div>
          ...
          <div className='bg-white p-5 rounded-xl shadow-sm border border-purple-100 flex flex-col justify-between'>
            ...
            <div className='mt-2 text-[10px] text-purple-300 flex items-center'>
              <HeartHandshake className="w-3 h-3 mr-1" /> Atuação social
            </div>
          </div>
